...
/// </summary>
public sealed class SemanticKernelProviderBackup
{
    private readonly Kernel _kernel;

    public SemanticKernelProviderBackup(IServiceProvider serviceProvider, IConfiguration configuration, IHttpClientFactory httpClientFactory)
    {
